...
if ($specialResponse) {
    ...
    $aiResponse = askOpenAI($context, $persona, $lang);
}

// --- Save AI response ---
saveChatLog($userId, 'assistant', $aiResponse, $persona, $lang);

// --- XP Reward Logic ---
$xp = rand(1, 5); // Simple XP reward per message
updateXP($userId, $xp);
